\hypertarget{classperif_1_1AccelGyro}{}\section{perif\+::Accel\+Gyro Class Reference}
\label{classperif_1_1AccelGyro}\index{perif::AccelGyro@{perif::AccelGyro}}
...
\mbox{\Hypertarget{classperif_1_1AccelGyro_abb2b2920505708a2108e95fa4d6fd433}\label{classperif_1_1AccelGyro_abb2b2920505708a2108e95fa4d6fd433}} 
\index{perif::AccelGyro@{perif::AccelGyro}!AccelGyro@{AccelGyro}}
\index{AccelGyro@{AccelGyro}!perif::AccelGyro@{perif::AccelGyro}}
...
Definition at line 16 of file Accel\+Gyro.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{17     : \mbox{\hyperlink{classperif_1_1I2CPerif_a80ab5e9bf8a8f2f2278a35d646442b1b}{I2CPerif}}(\textcolor{stringliteral}{"AccelGyro"}, \mbox{\hyperlink{classperif_1_1I2CPerif_a3275bcc89b3d8ddfa221fb76669c2d45}{address}}),}
\DoxyCodeLine{18       mpu(\mbox{\hyperlink{classperif_1_1I2CPerif_a3275bcc89b3d8ddfa221fb76669c2d45}{address}}, *\textcolor{keyword}{this}),}
\DoxyCodeLine{19       data\{0, 0, 0, 0, 0, 0\},}
\DoxyCodeLine{20       lastUpdate(0) \{}
\DoxyCodeLine{21 \}}
...
\mbox{\Hypertarget{classperif_1_1AccelGyro_aebbf13d39d889c298103f16a02b4cce4}\label{classperif_1_1AccelGyro_aebbf13d39d889c298103f16a02b4cce4}} 
\index{perif::AccelGyro@{perif::AccelGyro}!begin@{begin}}
\index{begin@{begin}!perif::AccelGyro@{perif::AccelGyro}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{23                       \{}
\DoxyCodeLine{24   \textcolor{comment}{// start the I2C wire}}
\DoxyCodeLine{25   \textcolor{keywordtype}{bool} wireRes = \mbox{\hyperlink{classperif_1_1I2CPerif_aa91b8eca31223fddd191a50b8a0a526d}{I2CPerif::begin}}();}
\DoxyCodeLine{26   \textcolor{comment}{// perform mpu6050 initialization}}
\DoxyCodeLine{27   mpu.\mbox{\hyperlink{classMPU6050_abd8fc6c18adf158011118fbccc7e7054}{initialize}}();}
\DoxyCodeLine{28   \textcolor{keywordflow}{return} wireRes \&\& mpu.\mbox{\hyperlink{classMPU6050_a95ffab7b44fce3834236e0813687d11a}{testConnection}}();}
\DoxyCodeLine{29 \}}

\end{DoxyCode}
\mbox{\Hypertarget{classperif_1_1AccelGyro_a383ef99745838084b620c2e0bfd8d129}\label{classperif_1_1AccelGyro_a383ef99745838084b620c2e0bfd8d129}} 
\index{perif::AccelGyro@{perif::AccelGyro}!getAcceleration@{getAcceleration}}
\index{getAcceleration@{getAcceleration}!perif::AccelGyro@{perif::AccelGyro}}
\subsubsection{\texorpdfstring{getAcceleration()}{getAcceleration()}}
{\footnotesize\ttfamily const int16\+\_\+t $\ast$ perif\+::\+Accel\+Gyro\+::get\+Acceleration (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})}

Obtains the acceleration data.

\begin{DoxyReturn}{Returns}
acceleration coords (x, y, z) 
\end{DoxyReturn}


Definition at line 31 of file Accel\+Gyro.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{31                                           \{}
\DoxyCodeLine{32   mpu.\mbox{\hyperlink{classMPU6050_a658dfc7e35b7fdba360a75f137bde33a}{getAcceleration}}(data,}
\DoxyCodeLine{33     \&data[1],}
\DoxyCodeLine{34     \&data[2]);}
\DoxyCodeLine{35   \textcolor{keywordflow}{return} data;}
\DoxyCodeLine{36 \}}

\end{DoxyCode}
\mbox{\Hypertarget{classperif_1_1AccelGyro_a494e07c2792ac25b013d05ddb3d89234}\label{classperif_1_1AccelGyro_a494e07c2792ac25b013d05ddb3d89234}} 
\index{perif::AccelGyro@{perif::AccelGyro}!getRotation@{getRotation}}
\index{getRotation@{getRotation}!perif::AccelGyro@{perif::AccelGyro}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{38                                       \{}
\DoxyCodeLine{39   mpu.\mbox{\hyperlink{classMPU6050_a8ca85b87e7e0230921062fce7889b0d1}{getRotation}}(\&data[3],}
\DoxyCodeLine{40     \&data[4],}
\DoxyCodeLine{41     \&data[5]);}
...
\index{perif::AccelGyro@{perif::AccelGyro}!getTimer@{getTimer}}
\index{getTimer@{getTimer}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!initialize@{initialize}}
\index{initialize@{initialize}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!isConnected@{isConnected}}
\index{isConnected@{isConnected}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!readBit@{readBit}}
\index{readBit@{readBit}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!readBits@{readBits}}
\index{readBits@{readBits}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!readByte@{readByte}}
\index{readByte@{readByte}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!readByte\_@{readByte\_}}
\index{readByte\_@{readByte\_}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!readBytes@{readBytes}}
\index{readBytes@{readBytes}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!readBytes\_@{readBytes\_}}
\index{readBytes\_@{readBytes\_}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!readWord@{readWord}}
\index{readWord@{readWord}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!registerHook@{registerHook}}
\index{registerHook@{registerHook}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!SelectRegister@{SelectRegister}}
\index{SelectRegister@{SelectRegister}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!update@{update}}
\index{update@{update}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!writeBit@{writeBit}}
\index{writeBit@{writeBit}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!writeBits@{writeBits}}
\index{writeBits@{writeBits}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!writeByte@{writeByte}}
\index{writeByte@{writeByte}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!writeByte\_@{writeByte\_}}
\index{writeByte\_@{writeByte\_}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!writeBytes@{writeBytes}}
\index{writeBytes@{writeBytes}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!writeBytes\_@{writeBytes\_}}
\index{writeBytes\_@{writeBytes\_}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!writeWord@{writeWord}}
\index{writeWord@{writeWord}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!address@{address}}
\index{address@{address}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!hooks@{hooks}}
\index{hooks@{hooks}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!initialized@{initialized}}
\index{initialized@{initialized}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!port@{port}}
\index{port@{port}!perif::AccelGyro@{perif::AccelGyro}}
...
\index{perif::AccelGyro@{perif::AccelGyro}!timer@{timer}}
\index{timer@{timer}!perif::AccelGyro@{perif::AccelGyro}}
